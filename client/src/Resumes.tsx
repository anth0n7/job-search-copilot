    ...
    return(
        <div>
            <h1 className="flex justify-center font-semibold mb-2">Resume</h1>
             <textarea id="resume_text" value={resume_text} className="bg-gray-900 border border-gray-700 rounded-lg text-gray-100 focus:outline-none focus:ring-2 focus:ring-sky-500 w-full" rows={8} onChange={(e) => setResumeText(e.target.value)}></textarea>
